    ...
    <View style={styles.smallCol}>
      <FlatList
        ...
        ListHeaderComponent={
          <TouchableOpacity
            activeOpacity={0.9}
            style={-1 == active ? styles.itemActive : styles.item}
            onPress={() => {
              fetchProducts('new');
              setActive(-1);
            }}>
            <>
              <View
                style={-1 == active ? styles.itemIconActive : styles.itemIcon}>
                <MaterialCommunityIcons
                  name="chart-line"
                  size={18}
                  color={-1 == active ? '#fff' : '#FC5475'}
                />
              </View>
              <Text style={-1 == active ? styles.textActive : styles.text}>
                Топ продаж
              </Text>
            </>
          </TouchableOpacity>
